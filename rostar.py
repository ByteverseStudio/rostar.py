...
switch = {
    "download": lambda : downloadPlace(sys.argv[2], sys.argv[3]),
    "upload": lambda : uploadPlace(open(sys.argv[2]).read(), sys.argv[3], sys.argv[4], sys.argv[5] if len(sys.argv) > 5 else "Published"),
}
